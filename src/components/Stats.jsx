          ...
          {stats.map((stat, index) => (
            ...
            >
              ...
              <motion.div
                ...
                className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-white border border-gray-200 shadow-sm mb-4"
              >
                <stat.icon className="w-8 h-8" style={{ color: wine }} />
              </motion.div>
